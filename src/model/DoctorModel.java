...
public class DoctorModel extends PersonModel {
    ...
    public DoctorModel(int doctorId, String name, String surname, int age, String passportCode, PersonType personType, String phoneNumber, DoctorSpecialization specialization) {
